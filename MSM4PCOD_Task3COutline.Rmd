...
```
Metapopulations of marine mammals where disturbance and sampling are not uniformly distributed. 

How should we collect data to maximize the ability to detect declines?

We propose to investigate this question using a simulation tool (an R package and/or Shiny app).
