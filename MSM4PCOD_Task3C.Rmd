...
- Think about adding in acoustic survey simulation, long-term trend in GVPs, fixed
...
### Possibly part of another task (Megan power analyses)?
...
- For more complex scenario, crank up/down migration parameters
